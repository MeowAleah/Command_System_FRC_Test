...
public final class Constants {
    public static final int flMotorCANID = 0;
    public static final int frMotorCANID = 1;
    public static final int blMotorCANID = 2;
    public static final int brMotorCANID = 3;
